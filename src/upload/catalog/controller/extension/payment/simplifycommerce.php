...
class ControllerExtensionPaymentSimplifyCommerce extends Controller
{
     ...
     * @return void
     */
    public function update_page_header(&$route, &$data)
    {
        ...
        $scriptLink = 'https://www.simplify.com/commerce/simplify.pay.js';
        $data['scripts'][$scriptLink] = $scriptLink;

        $stylesLink = 'catalog/view/javascript/simplifycommerce/embedded-payment-form.css';
        $data['styles'][$stylesLink] = array(
            'href'  => $stylesLink,
            'rel'   => 'stylesheet',
            'media' => 'screen',
        );
